...
// ✨ THÊM MỚI: Reference images configuration
...
// ✨ THÊM MỚI: Check reference images on startup
...
app.post("/api/generate-image", async (req: Request, res: Response) => {
  try {
    ...
    // Load reference image based on rarity
...
app.listen(PORT, () => {
  ...
  console.log(`🌊 Walrus Keypair: ${walrusKeypair ? "✓ Configured" : "✗ Not configured"}`);
});
